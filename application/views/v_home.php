...
<body>
	<div class="container">
		...
		<div class="col-md-12">
			<div class="row">
				<?= anchor('cadastro/create', 'Novo Usuario', array('class' => 'btn btn-success')); ?>
			</div>
			<div class="row">
				<h3><?= $cadastros->num_rows(); ?> usuário(s)</h3>
			</div>
			<div class="row">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger" id="btn_excluir">Sim. Deletar usuário</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
